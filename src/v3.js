export const v3 = {
  "productName": "Micro Cashflow Forecast",
  ...
  "capabilities": [
    "Domain-specific workbench: 13-Week Cashflow Forecaster",
    "Operational table: Weekly forecast",
  ...
  "releaseChecklist": [
    ...
    "Runway Weeks reaches production threshold",
    "Safety Floor Risk is documented with evidence",
    "Scenario Spread has no unresolved blocker",
    "13-week forecast CSV verified",
    "Owner-friendly summary verified",
