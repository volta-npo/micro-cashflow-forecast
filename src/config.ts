  ...
  "criteria": [
    {
      ...
      "prompt": "Implement and verify weekly cash model with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "scenario-toggles",
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify scenario toggles with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify owner explanation notes with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "risk-flags",
      "label": "Risk flags",
      "weight": 15,
      "defaultStatus": "not-started",
      "prompt": "Implement and verify risk flags with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "evidence-quality",
